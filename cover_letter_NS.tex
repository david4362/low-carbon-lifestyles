...
How much can lifestyle change contribute to climate mitigation? The direct effects are straightforward to estimate, but if the money saved through low-carbon living is re-spent on other consumption, around half of the initial saving would be offset, according to the most recent global assessment. This re-spending is an assumption inherited from energy-efficiency analysis, never tested for lifestyle change. We provide the first such empirical test.
...
We believe three findings will interest your readership. First, lifestyle adopters show large net emission reductions---adjusted differences of $-$24\% and $-$30\% for car-free and flight-free living relative to comparison-group footprints. Second, there is no automatic rebound: despite large financial savings, adopters emit \textit{less}, not more, across the rest of their budget, falling significantly below proportional re-spending benchmarks. Third, motivation shapes the outcome: households with stronger environmental self-identity show lower emissions across the entire budget, so the net climate benefit of a lifestyle transition depends on who adopts it, and why. Intuitive as these results may seem, they contradict the mechanical re-spending assumption embedded in current modelling and policy analysis. For mobility-related lifestyle change, the full direct emission saving is a better estimate of the climate benefit than rebound-discounted figures, and motivational composition offers a tractable way to represent heterogeneity in sustainable-consumption scenarios.

The work spans industrial ecology, behavioural science, and environmental economics. Its most transferable novelty is the measurement approach: population-scale linkage of financial transactions, administrative registers, and psychological constructs opens everyday consumption to direct observation, and we expect future research to extend it to other consumption domains and countries. We believe the manuscript speaks directly to the interdisciplinary readership of \textit{Nature Sustainability}.
